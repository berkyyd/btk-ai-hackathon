...
export default function HomePage() {
  return (
    <div className='py-8 min-h-screen'>
      ...
      {/* YBS Tanımı */}
      <Card className='mb-16 card-glass'>
        ...
        <p className='text-base text-text-secondary leading-relaxed text-justify'>
      ...
      <section className='text-center'>
        <h2 className='text-3xl font-bold text-text-primary mb-8 border-b-2 border-primary-500 pb-3'>
          Uygulama Modülleri
        </h2>
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          <Link href="/mufredat" className='block'>
            <Card className='h-full flex flex-col items-center justify-center text-center feature-card hover:shadow-glow-blue transition-all duration-400'>
              <h3 className='text-2xl font-bold text-primary-400 mb-2'>Müfredat</h3>
          ...
          <Link href="/ders-notlari" className='block'>
            <Card className='h-full flex flex-col items-center justify-center text-center feature-card hover:shadow-glow-purple transition-all duration-400'>
