...
import { collection, query, where, getDocs, addDoc, orderBy, doc, updateDoc } from 'firebase/firestore/lite';
...
export async function PUT(request: NextRequest) {
  try {
    ...
    // PUT request - body: { title, content, tags, isPublic }
