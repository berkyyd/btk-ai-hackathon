              ...
              <div className="overflow-x-auto">
                <table className="w-full">
                  ...
                  <tbody className="bg-gray-100 divide-y divide-gray-300">
                       ...
                       return (
                         <tr key={course.code + courseIndex} className="hover:bg-purple-100 transition-colors bg-gray-100">
                       ...
                       <>
                         ...
                         {semester.elective_courses
                           ...
                           .map((course, courseIndex) => (
                             <tr key={`elective-${course.code}-${courseIndex}`} className="hover:bg-blue-100 transition-colors bg-blue-50">
                         ...
                         {semester.elective_courses.some(course => course.name.includes('Üniversite Seçmeli Dersler')) && (
                           <>
                             ...
                             {semester.elective_courses
                               .filter(course => course.name.includes('Üniversite Seçmeli Dersler'))
                               .map((course, courseIndex) => (
                                 <tr key={`usd-${course.code}-${courseIndex}`} className="hover:bg-purple-100 transition-colors bg-purple-50">
