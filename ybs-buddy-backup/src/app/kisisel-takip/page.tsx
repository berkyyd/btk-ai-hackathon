                          ...
                          <div key={answer.questionId} className="mb-4 p-3 bg-white rounded border border-purple-200 shadow-sm">
                            <div className="flex items-start justify-between mb-2">
                              ...
                              <span className={`px-2 py-1 text-xs font-bold rounded ${
                                !answer.userAnswer || (typeof answer.userAnswer === 'string' && answer.userAnswer.trim() === '') 
                            ...
                            <div className="space-y-1">
                              ...
                              {(!answer.isCorrect || !answer.userAnswer || (typeof answer.userAnswer === 'string' && answer.userAnswer.trim() === '')) && (
                                <div className="text-sm">
